...
{
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.AspNetCore.Http.RequestDelegateGenerator, Version=10.0.2.0, Culture=neutral, PublicKeyToken=adb9793829ddae60", "10.0.2.0")]
...
namespace Microsoft.AspNetCore.Http.Generated
{
    ...
    file static class GeneratedRouteBuilderExtensionsCore
    {
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "d7oAHfHnzDtHzjEmWaeMCQEMAABBcHBIb3N0aW5nLmNz")]
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "b3I6/98YVrK0x6eP3JP4HXYBAABFbmRwb2ludHNIb3N0aW5nLmNz")]
            ...
            Delegate handler)
        {
            MetadataPopulator populateMetadata = (methodInfo, options) =>
            {
                ...
                options.EndpointBuilder.Metadata.Add(new System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.AspNetCore.Http.RequestDelegateGenerator, Version=10.0.2.0, Culture=neutral, PublicKeyToken=adb9793829ddae60", "10.0.2.0"));
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "d7oAHfHnzDtHzjEmWaeMCXAMAABBcHBIb3N0aW5nLmNz")]
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "b3I6/98YVrK0x6eP3JP4HeABAABFbmRwb2ludHNIb3N0aW5nLmNz")]
            ...
            Delegate handler)
        {
            MetadataPopulator populateMetadata = (methodInfo, options) =>
            {
                ...
                options.EndpointBuilder.Metadata.Add(new ParameterBindingMetadata("testId", parameters[0], hasTryParse: true, hasBindAsync: false, isOptional: true));
                options.EndpointBuilder.Metadata.Add(new ProducesResponseTypeMetadata(statusCode: StatusCodes.Status200OK, type: typeof(string), contentTypes: GeneratedMetadataConstants.PlaintextContentType));
                return new RequestDelegateMetadataResult { EndpointMetadata = options.EndpointBuilder.Metadata.AsReadOnly() };
            };
            RequestDelegateFactoryFunc createRequestDelegate = (del, options, inferredMetadataResult) =>
            {
                ...
                jsonSerializerOptions.MakeReadOnly();
                var objectJsonTypeInfo = (JsonTypeInfo<object?>)jsonSerializerOptions.GetTypeInfo(typeof(object));
                var testId_RouteOrQueryResolver = GeneratedRouteBuilderExtensionsCore.ResolveFromRouteOrQuery("testId", options.RouteParameterNames);
                ...
                {
                    var wasParamCheckFailure = false;
                    // Endpoint Parameter: testId (Type = int?, IsOptional = True, IsParsable = True, IsArray = False, Source = RouteOrQuery)
                    var testId_raw = testId_RouteOrQueryResolver(httpContext);
                    var testId_temp = testId_raw.Count > 0 ? (string?)testId_raw : null;
                    global::System.Int32? testId_parsed_temp = default;
                    if (GeneratedRouteBuilderExtensionsCore.TryParseExplicit<int>(testId_temp!, CultureInfo.InvariantCulture, out var testId_temp_parsed_non_nullable))
                    {
                        testId_parsed_temp = testId_temp_parsed_non_nullable;
                    }
                    else if (string.IsNullOrEmpty(testId_temp))
                    {
                        testId_parsed_temp = null;
                    }
                    else
                    {
                        wasParamCheckFailure = true;
                    }
                    int? testId_local = testId_parsed_temp!;
                    ...
                    var result = handler(testId_local);
                    if (result is string)
                    {
                        httpContext.Response.ContentType ??= "text/plain; charset=utf-8";
                    }
                ...
                async Task RequestHandlerFiltered(HttpContext httpContext)
                {
                    ...
                    var result = await filteredInvocation(EndpointFilterInvocationContext.Create<global::System.Int32?>(httpContext, testId_local));
                    if (result is not null)
                    {
                        await GeneratedRouteBuilderExtensionsCore.ExecuteReturnAsync(result, httpContext, objectJsonTypeInfo);
                    }
            ...
            var castHandler = Cast(handler, global::System.String (global::System.Int32? arg0) => throw null!);
            return MapCore(
                endpoints,
                pattern,
                handler,
